...
class HeaderWithService extends Component {
        ...
        return (
            <header className="govuk-header " role="banner" data-module="header">
                <div className="govuk-header__container govuk-width-container">
                        ...
                        <a href="#" className="govuk-header__link govuk-header__link--homepage">
                            <span className="govuk-header__logotype">
                                ...
                                <svg role="presentation" focusable="false" className="govuk-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 132 97" height="32" width="36">
                                    ...
                                    <image src={this.CrownIcon} className="govuk-header__logotype-crown-fallback-image"></image>
                                </svg>
                    ...
                    <HeaderServiceName serviceTitle={this.props.serviceTitle}/>
                </div>
            </header>
        );
    }
...
export default HeaderWithService;