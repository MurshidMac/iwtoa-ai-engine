...
//        if(impurityAlgorithmGini.isEmpty() != true || impurityAlgorithmGini == "entropy") {
//        	impurityAlgorithmGini = "entropy";
//        }
//        
//        if(impurityAlgorithmGini.isEmpty() == true || impurityAlgorithmGini == "variance") {
//        	impurityAlgorithmGini = "variance";
//        }
        
        // By Default There will be two algorithms 
...
//        System.out.println("Learned classification tree model:\n" + model.toDebugString());        
        ...
        // Save and load model
//        model.save(javaSparkContext.sc(), "target/myGiniDecisionTreeClassificationModel");
//        modelEntropy.save(javaSparkContext.sc(), "target/myEntropyDecisionTreeClassificationModel");
//        modelVariance.save(javaSparkContext.sc(), "target/myVarienceDecisionTreeClassificationModel");
